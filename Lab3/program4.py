class OxfordDictionary(object):
	oxfordDict = {'person': 'a human being','marathon': 'a running race that is about 4 miles','resist': 'to remain strong against the force','run': 'to move with haste; act quickly'}	
